    ...
    <div class="article_title">
        <div class="label_input">
            ...
            <div class="input_area">
                <input name="title" type="text" value="{{$event_data->title ?? ''}}">
        ...
        <div class="label_input">
            ...
            <div class="input_area">
                <textarea class="textarea" name="introduction" type="text" >{{$event_data->introduction ?? ''}}</textarea>
                @if ($errors->first('introduction'))
                    <p class="validation">※{{$errors->first('introduction')}}</p>
                @endif
            </div>
        </div>
        <labelinput-component :event-date='@json($event_data->date)' attribute-name="event_date">
        ...
        <div class="label_input">
            ...
            <div class="input_area" >
                <input name="st_time" type="text" value="{{$event_data->st_time ?? ''}}"></input>
        ...
        <div class="label_input">
            ...
            <div class="input_area">
                <input name="end_time" type="text" value="{{$event_data->end_time ?? ''}}"></input>
        ...
        <div class="label_input">
            ...
            <div class="input_area">
                <input name="summary_date" type="text" value="{{$event_data->date_type ?? ''}}"></input>
        ...
        <div class="label_input">
            ...
            <div class="input_area">
                <input name="web_name" type="text" value="{{$event_data->web_name ?? ''}}"></input>
        ...
        <div class="label_input">
            ...
            <div class="input_area">
                <input name="web_url" type="text" value="{{$event_data->web_url ?? ''}}"></input>
        ...
        <div class="label_input">
            ...
            <div class="input_area">
                <input name="fee_type" type="text" value="{{$event_data->fee_type ?? ''}}"></input>
        ...
        <div class="label_input">
            ...
            <div class="input_area">
                <input name="fee" type="text" value="{{$event_data->fee ?? ''}}"></input>
                @if ($errors->first('fee'))
        ...
        <div class="label_input">
            ...
            <div class="input_area">
                <input name="image_url" type="text" value="{{$event_data->image_url ?? ''}}"></input>
        ...
        <div class="label_input">
            ...
            <div class="input_area">
                <input name="reference_name" type="text" value="{{$event_data->reference_name ?? ''}}"></input>
        ...
        <div class="label_input">
            ...
            <div class="input_area">
                <input name="reference_url" type="text" value="{{$event_data->reference_url ?? ''}}"></input>
        ...
        <div class="label_input">
            ...
            <div class="input_area">
                <input name="release_date" type="text" value="{{$event_data->release_date ?? ''}}"></input>
        ...
        <div class="label_input">
            ...
            <div class="input_area">
                <select name="genre_id" value="{{$event_data->genre_id ?? ''}}">
                    @foreach($genre as $g)
                        <option value="{{$g->id}}" 
...
--}}
        <div class="label_input">
            ...
            <div class="input_area">
                <input name="regi_group_name" type="text" value="{{$event_data->regi_group_name ?? ''}}"></input>
        ...
        <div class="label_input">
            ...
            <div class="input_area">
                <input name="regi_name" type="text" value="{{$event_data->regi_name ?? ''}}"></input>
        ...
        <div class="label_input">
            ...
            <div class="input_area">
                <input name="regi_tel" type="text" value="{{$event_data->regi_tel ?? ''}}"></input>
        ...
        <div class="label_input">
            ...
            <div class="input_area">
                <input name="regi_mail" type="text" value="{{$event_data->regi_mail ?? ''}}"></input>
    ...
    <div>
        <button type="submit" value="register">登録</button>
    </div>
</div>
</form>
@endsection
